...
type OpenBrowser struct {
	...
	Enable *bool `json:"enable,omitempty" yaml:"enable" jsonschema:"default=true" jsonschema_description:"Open a browser automatically in the device flow. The default value is true. The GHTKN_OPEN_BROWSER environment variable takes precedence over this value"`
}
...
type Clipboard struct {
	...
	Enable *bool `json:"enable,omitempty" yaml:"enable" jsonschema:"default=false" jsonschema_description:"Copy the one-time code to the system clipboard in the device flow. The default value is false. The -clipboard flag and the GHTKN_CLIPBOARD environment variable take precedence over this value"`
}
...
type Backend struct {
	...
	// over this value.
	Type string `json:"type,omitempty" yaml:"type" jsonschema:"default=keyring" jsonschema_description:"The backend type where access tokens are stored. Either 'keyring' (the default), 'text', or 'agent'. The GHTKN_BACKEND environment variable takes precedence over this value"`
}
